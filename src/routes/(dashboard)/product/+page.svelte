...
<div class="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <CreateProduct {form} isOpen={isAddProductModalOpen} categories={data.categories} onClose={() => onActionModalCLose('add')} />
  <DeleteProduct isOpen={isDeleteProductModalOpen} productId={selectedProduct?.id} {form} onClose={() => onActionModalCLose('delete')} />
  <EditProduct product={selectedProduct} {form} isOpen={isEditProductModalOpen} categories={data.categories} onClose={() => onActionModalCLose('edit')} />
